...
public abstract class DamageDistributionBuilder {
     ...
     */
    public abstract IDamageDistribution standardDist(@Nonnull List<Pair<EntityEquipmentSlot, EnumPlayerPart[]>> priorityTable);
     ...
     */
    public abstract IDamageDistribution randomDist(boolean nearestFirst, boolean tryNoKill);
}
