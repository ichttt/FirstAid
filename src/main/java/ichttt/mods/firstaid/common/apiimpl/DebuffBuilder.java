...
public class DebuffBuilder implements IDebuffBuilder {
    ...
    @Override
    public DebuffEntry build(@Nonnull EnumDebuffSlot slot) {
        //Build the finished debuff
        FirstAid.LOGGER.debug("Building debuff from mod {} for slot {} with potion effect {}, type = {}", CommonUtils.getActiveModidSafe(), slot, this.potionName, this.isOnHit ? "OnHit" : "Constant");
        ...
        return new DebuffEntry(slot, debuff);
    }
}
